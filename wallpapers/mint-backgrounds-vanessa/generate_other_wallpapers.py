...
os.system("sed \"s/cinnamon-wp/gnome-wp/\" cinnamon-background-properties/linuxmint-%s.xml > gnome-background-properties/linuxmint-%s.xml" % (CODENAME.lower(), CODENAME.lower()))
os.system("sed \"s/cinnamon-wp/mate-wp/\" cinnamon-background-properties/linuxmint-%s.xml > mate-background-properties/linuxmint-%s.xml" % (CODENAME.lower(), CODENAME.lower()))

#MAKE Xfce Wallpapers
os.chdir("xfce4-backdrops")
os.system("rm -f *")
os.system("ln -s /usr/share/backgrounds/linuxmint-%s/*.* ./" % CODENAME.lower())
os.system("rename 's/^/%s_/' *" % CODENAME.lower())
os.chdir("..")

# MAKE KDE Wallpapers
with open ("cinnamon-background-properties/linuxmint-%s.xml" % CODENAME.lower(), "r") as metadata_file:
